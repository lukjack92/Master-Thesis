...
<div class="container">
	<div class="col-md-6 mx-auto bg-form">
		<h3>Sign Up to Application Android</h3>
		<form>
			<label>User Name</label>
			<div class="form-group has-feedback">
				<input class="form-control" type="text" id="username" autofocus required>
			</div>
			<label>Email</label>
			<div class="form-group has-feedback">
			...
			<div class="form-group">
				<button class="btn btn-lg btn-primary btn-block" onclick="signUpToApp()">Sign Up</button>
			</div>
		</form>
	...
	<script type="text/javascript" src="signUpApp.js"></script>
</body>
</html>